...
//variable which hold the color of the line
var COLOURS = [ 'green'];

//Sketch.create is a method provided by sketch.js which makes drawing 
//on the canvas easier and implements events for touch support 
Sketch.create({
    ...
    update: function() {
        //changing the values inside the radius effects the line thickness 
        //which was an easy way to make quick changes
        radius = 20 + abs( sin( this.millis * 0.3 ) * 100 );
    },
    ...
    touchmove: function() {
        ...
        //a for loop which checks for any movements either through mouse or touch input and if that
        //is the case a line gets drawn.
        for ( var i = this.touches.length - 1, touch; i >= 0; i-- ) {

            touch = this.touches[i];

            //changing the lineCap from round to flat changed the line appearance a lot
