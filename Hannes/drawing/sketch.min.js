...
//variable which holds the color of the line
var COLOURS = [ 'green'];
var radius = 1;

//Sketch.create is a method provided by sketch.js which makes drawing on the canvas easier and 
//implements events for touch support 
Sketch.create({
    ...
    update: function() {
        ...
        radius = 20 + abs( sin( this.millis * 0.003 ) * 1 );
    },
