...
//an object is created which holds the information about the bubbles
Particle.prototype = {
    ...
    move: function() {
        ...
        //I changed the multiplier from 0.1 to 0 to make the particles stay in place
        this.vx += sin( this.theta ) * 0;
        this.vy += cos( this.theta ) * 0;
        //the radius was  changed in order change the time until the particles disapear
        this.radius *= 0.995;
        this.alive = this.radius > 0.5;
    },
    //the bubbles are drawn
    draw: function( ctx ) {
...
//max number of particles was increased rise the number of bubbles
//before the first ones disapear again
var MAX_PARTICLES = 5000;

//different colors were inserted to create new visual stimulation
var COLOURS = [ '#ff0000', '#0cff00', '#00cdff', '#7800ff', '#000000', '#000000', '#000000' ];

//empty arrays are created 
var particles = [];
var pool = [];

//sketch.create provides access to various methods which can implemented
...
demo.setup = function() {
    ...
    //I changed the amount of particles which are displayed from the start
    for ( i = 0; i < 5; i++ ) {
...
demo.spawn = function( x, y ) {
    ...
    //if statement which checks if the particle.lenght is bigger or equal then 
    //the max number(5000) and then pushes new particles into the array
...
demo.draw = function() {
    ...
    /*demo.globalCompositeOperation was changed from lighter to darker to increase the contrast between
      the particles and the white background*/
...
/*"mousemove" was first changed into "mousedown"" to make it feel more like a drawing scenario but 
  "mousemove" works without problems with touch devices*/
